...
class ApplantisInfoView extends ConsumerStatefulWidget {
  const ApplantisInfoView({super.key});

  @override
  ConsumerState<ApplantisInfoView> createState() => _ClubInfoViewState();
}

class _ClubInfoViewState extends ConsumerState<ApplantisInfoView> {
  @override
